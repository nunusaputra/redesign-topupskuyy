...
const SideContent = () => {
  ...
  return (
    <div className="w-full min-h-16 bg-slate-600/30 backdrop-blur-xl border-2 border-slate-700 shadow-black rounded-lg flex flex-col gap-5 lg:w-[35%] lg:h-screen lg:overflow-auto lg:sticky lg:top-20 p-4">
      {/* Image Content */}
      <div className="w-full h-30 px-4 py-2 flex items-center gap-2 bg-[#121c32] rounded-lg shadow-lg">
        <div className="w-35 md:w-50 lg:w-35 h-20 rounded-lg overflow-hidden">
          <img src={data.image} alt="" className="w-full h-full object-cover" />
        </div>
        <div className="w-full lg:w-65 h-20 rounded-lg overflow-hidden flex flex-col gap-2 px-2 bg-slate-600/40 backdrop-blur-2xl">
          <h1 className="text-md text-white font-bold tracking-wide">
            {data.name}
          </h1>
          <div className="flex gap-1">
            <div className="flex items-center gap-1 px-2 sm:px-3 lg:px-1 xl:px-3 py-2 rounded-lg bg-slate-600/30 backdrop-blur-xl border-1 border-slate-600">
